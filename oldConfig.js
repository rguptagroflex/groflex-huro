...
import WebStorageKey from "./src/app/enums/web-storage-key.enum";
...
let apiRoot =
  WebStorageService.getItem(WebStorageKey.API_ROOT) || apiServers[releaseStage];
