  ...
  get displayDeliveryPeriodStartDate() {
    switch (this.recurrence) {
      case "weekly":
        ...
        // 	'DD.MM.YY'
        // );
        return formateClientDateMonthYear(
          moment(this.startDate).isoWeekday(-6)
        );
      case "biweekly":
        // return formatDate(
        // 	moment(this.startDate)
        ...
        // );
        return formateClientDateMonthYear(
          moment(this.startDate).add(-1, "weeks").isoWeekday(-6)
        );
      case "monthly":
        // return formatDate(
        // 	moment(this.startDate)
        ...
        // );
        return formateClientDateMonthYear(
          moment(this.startDate).add(-1, "months").startOf("month")
        );
      case "bimonthly":
        // return formatDate(
        // 	moment(this.startDate)
        ...
        // );
        return formateClientDateMonthYear(
          moment(this.startDate).add(-2, "months").startOf("month")
        );
      case "quarter":
        // return formatDate(
        // 	moment(this.startDate)
        ...
        // );
        return formateClientDateMonthYear(
          moment(this.startDate).add(-3, "months").startOf("month")
        );
      case "biyearly":
      ...
      case "yearly":
        ...
        // );
        return formateClientDateMonthYear(
          moment(this.startDate).add(-1, "years").startOf("year")
        );
    }
  }
  ...
  get displayDeliveryPeriodEndDate() {
    switch (this.recurrence) {
      ...
      case "quarter":
        ...
        // );
        return formateClientDateMonthYear(
          moment(this.startDate).add(-1, "months").endOf("month")
        );
      case "biyearly":
        const currentMonth = moment(this.startDate).month() + 1;
        let endDate;
        if (currentMonth <= 6) {
          ...
          // 	.endOf('year')
          // 	.format(config.dateFormat.api);
          endDate = formatApiDate(
            moment(this.startDate).add(-1, "years").endOf("year")
          );
        } else {
          // endDate = moment(this.startDate)
          // 	.endOf('year')
          ...
          // 	.format(config.dateFormat.api);
          endDate = formatApiDate(
            moment(this.startDate).endOf("year").add(-6, "months")
          );
        }
