...
function disableSearchWhentListEmpty() {
  $(".is-slider .tabs li").on("click", function () {
    setTimeout(function () {
      if (
        $(".page-content.tabs-wrapper .tab-content.is-active .list-view-item")
          .length === 0
      ) {
    ...
    if ($(".infinite-scroll-loader").length) {
      ...
      $(window).on("scroll", function () {
        if (
          ...
          var clones = $(
            ".list-view .tab-content.is-active .list-view-inner"
          ).html();
          $(".infinite-scroll-loader").addClass("is-active");
          ...
          if (counter < 2) {
            setTimeout(function () {
              $(".infinite-scroll-loader").removeClass("is-active");
              $(".list-view .tab-content.is-active .list-view-inner").append(
                clones
              );
              counter = counter + 1;
            }, 1200);
