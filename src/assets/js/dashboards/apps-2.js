...
$(document).ready(function () {
  ...
  //Search contacts
  $(".title-wrap .search-button, .title-wrap .cancel-search-button").on(
    "click",
    function () {
      $(this)
        .closest(".title-wrap")
        .find(".control, h3, .button")
  ...
  $(".inbox-message").on("click", function () {
    ...
    setTimeout(function () {
      $(".inbox-message-details")
        .addClass("is-hidden")
        .removeClass("mobile-active tablet-active");
      $("#" + targetMessage)
        .removeClass("is-hidden")
        .addClass("mobile-active tablet-active");
    }, 450);
    setTimeout(function () {
