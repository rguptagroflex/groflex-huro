...
$(document).ready(function () {
  ...
  if ($("#trend-chart").length) {
    ...
    var trendWidgetChart = new ApexCharts(
  ...
  if ($("#area-stats-widget-chart").length) {
    ...
    var areaStatsChart = new ApexCharts(
  ...
  if ($("#flex-stat-radial").length) {
    ...
    var flexStatRadial = new ApexCharts(
  ...
  if ($(".chart-group").length) {
    if ($("#widget-group-radial-1").length) {
      ...
      var widgetRadialGroup1 = new ApexCharts(
    ...
    if ($("#widget-group-radial-2").length) {
      ...
      var widgetRadialGroup2 = new ApexCharts(
    ...
    if ($("#widget-group-radial-3").length) {
      ...
      var widgetRadialGroup3 = new ApexCharts(
    ...
    if ($("#widget-group-radial-4").length) {
      ...
      var widgetRadialGroup4 = new ApexCharts(
    ...
    if ($("#widget-group-radial-5").length) {
      ...
      var widgetRadialGroup5 = new ApexCharts(
    ...
    if ($("#widget-group-radial-6").length) {
      ...
      var widgetRadialGroup6 = new ApexCharts(
